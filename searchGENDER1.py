...
class SearchGENDER1:
    def __init__(self,root):
        ...
        #combo box 
        search_label = Label(search_frame,text="Gender Type:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        search_combo["values"]=("Select Gender","Male","Female","Other")
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT ID,Name,Section,Crime,Year,Month,Jail,Gender,DOB,MOB,Address,Roll,Emial,Jailer,Photo FROM criminal where Gender='" +str(self.var_search.get()) + "'"
