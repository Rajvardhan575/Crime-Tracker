...
class SearchNAME1:
    def __init__(self,root):
        ...
        #combo box 
        search_label = Label(search_frame,text="Criminal Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT ID,Name,Section,Crime,Year,Month,Jail,Gender,DOB,MOB,Address,Roll,Emial,Jailer,Photo FROM criminal where Name='" +str(self.var_search.get()) + "'"
